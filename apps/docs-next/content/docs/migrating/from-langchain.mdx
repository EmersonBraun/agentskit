...
| `BufferMemory`, `ConversationBufferMemory` | `sqliteChatMemory`, `redisChatMemory`, `fileChatMemory` | Split from vector memory per [ADR 0003](https://github.com/EmersonBraun/agentskit/blob/main/docs/architecture/adrs/0003-memory-contract.md) |
...
- Every stream ends with a `done` chunk (never silently) — see [ADR 0001](https://github.com/EmersonBraun/agentskit/blob/main/docs/architecture/adrs/0001-adapter-contract.md) A3
...
- [ADR 0001 — Adapter contract](https://github.com/EmersonBraun/agentskit/blob/main/docs/architecture/adrs/0001-adapter-contract.md) — why provider swap is actually one line
