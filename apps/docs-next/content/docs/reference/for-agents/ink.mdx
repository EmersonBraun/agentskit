...
- [@agentskit/react](/docs/reference/for-agents/react) — sibling binding, same contract.
- [@agentskit/cli](/docs/reference/for-agents/cli) — `agentskit chat` ships ink internally.
