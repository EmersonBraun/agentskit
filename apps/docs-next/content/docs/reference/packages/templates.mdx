...
description: "Authoring toolkit for AgentsKit extensions — validated Tool, Skill, Adapter factories + on-disk scaffolds."
---
...
Register scaffolded packages like any other tool, skill, or adapter via [`createRuntime`](/docs/agents/runtime) or [`useChat`](/docs/ui/use-chat).
