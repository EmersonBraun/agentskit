...
- [Custom adapter](/docs/reference/recipes/custom-adapter) — emit `tool_call` chunks with partial args
- [Deterministic replay](/docs/reference/recipes/deterministic-replay) — record progressive runs for debugging
