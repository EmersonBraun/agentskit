...
The Adapter contract makes this trivial. See [ADR 0001](https://github.com/AgentsKit-io/agentskit/blob/main/docs/architecture/adrs/0001-adapter-contract.md).
...
- [Concepts: Skill](/docs/get-started/concepts/skill) — delegates by reference
- [Concepts: Runtime](/docs/get-started/concepts/runtime) — delegation as tool
