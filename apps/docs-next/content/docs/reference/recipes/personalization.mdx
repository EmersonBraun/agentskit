...
- [Graph memory](/docs/reference/recipes/graph-memory) — relationships, not just scalars
- [HITL approvals](/docs/reference/recipes/hitl-approvals) — gate updates that change sensitive preferences
