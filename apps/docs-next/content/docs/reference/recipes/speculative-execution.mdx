...
- [Deterministic replay](/docs/reference/recipes/deterministic-replay) — pin a winning trace
- [Token budget](/docs/reference/recipes/token-budget) — control cost per run
