...
- **A2A (Agent-to-Agent)** — `agent/card` · `task/invoke` · `task/cancel` · `task/approve` · `task/status`. JSON-RPC 2.0. [Recipe](/docs/recipes/open-specs).
...
- [Package: @agentskit/core](/docs/packages/core) (subpaths `/a2a`, `/manifest`, `/eval-format`)
- [MCP bridge](/docs/tools) — pairs with the Manifest spec
