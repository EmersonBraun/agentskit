...
See: [Architecture at a glance](/docs/get-started/architecture-at-a-glance) · [Use cases](/docs/use-cases)
...
- Coming from **Vercel AI SDK** and you want more than chat:
  start with [Build your first agent](/docs/get-started/getting-started/build-your-first-agent) and then [migrate from Vercel AI SDK](/docs/get-started/migrating/from-vercel-ai-sdk).
- Coming from **LangChain.js** and you want a smaller, tighter stack:
  start with [Architecture at a glance](/docs/get-started/architecture-at-a-glance) and then [migrate from LangChain.js](/docs/get-started/migrating/from-langchain).
- Coming from **Mastra** and you want slimmer contracts:
  start with [Use cases](/docs/use-cases) and then [migrate from Mastra](/docs/get-started/migrating/from-mastra).
