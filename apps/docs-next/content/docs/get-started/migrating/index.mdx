...
Read the "[When you should NOT use AgentsKit](/docs/get-started/comparison)" section of the README. If your use case falls in there, stay where you are — that's the honest answer.
