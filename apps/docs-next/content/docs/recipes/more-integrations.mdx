...
Pair with [mandatory sandbox](/docs/recipes/mandatory-sandbox) to
keep every browser call behind your policy.

## See also

- [Provider integrations](/docs/recipes/integrations) — S21 set (GitHub, Slack, Stripe, Postgres, S3, ...)
- [MCP bridge](/docs/recipes/mcp-bridge) — expose any of these to an MCP host
