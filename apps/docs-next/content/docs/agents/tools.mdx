---
title: Tools
description: "@agentskit/tools provides ready-made ToolDefinition values for web search, filesystem access, and shell execution. Pass them to createRuntime or useChat."
---
...
<ContributeCallout pkg="tools" title="Built a useful tool?" body="Tools follow a strict { name, description, schema, execute } contract. If you wrote one you'd use again — browser, API, database, integration — send it in. Others likely need the same thing." />
