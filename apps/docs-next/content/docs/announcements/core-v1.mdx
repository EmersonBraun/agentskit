...
From the [Manifesto](https://github.com/EmersonBraun/agentskit/blob/main/MANIFESTO.md), with v1 scorecards:
...
Additive. The substrate holds. Highlights from the [Master PRD](https://github.com/EmersonBraun/agentskit/issues/113):
...
Every contract is pinned to an ADR. Every package ships with tests and a size budget. The bar is high, the scope is clear, and the code is small. Open an issue, send a PR, or just [star the repo](https://github.com/EmersonBraun/agentskit) — the roadmap is public and every RFC is open.

**[Public roadmap →](https://github.com/users/EmersonBraun/projects/1)** · **[Contributing guide →](/docs/contributing)**

The board is maintainer-curated, but the inbox is open to everyone: file an [issue](https://github.com/EmersonBraun/agentskit/issues) or a [discussion](https://github.com/EmersonBraun/agentskit/discussions) and it gets triaged onto the roadmap.
...
Why this exists: **[Origin →](https://github.com/EmersonBraun/agentskit/blob/main/ORIGIN.md)**
